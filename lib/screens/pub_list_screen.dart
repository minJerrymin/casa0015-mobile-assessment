  ...
  Widget build(BuildContext context) {
    ...
    final pubs = mockPubs.where((p) {
      ...
      ..sort((a, b) {
        ...
        return b.comfortScore(prefersCalm: widget.preferences.prefersCalm || _calmOnly, soloMode: widget.preferences.soloMode || _soloOnly).compareTo(a.comfortScore(prefersCalm: widget.preferences.prefersCalm || _calmOnly, soloMode: widget.preferences.soloMode || _soloOnly));
      });
    ...
    return ListView(
      ...
      children: [
        ...
        Text('${pubs.length} spots ranked by atmosphere fit, screen quality, comfort, and distance.', style: const TextStyle(color: AppTheme.muted)),
